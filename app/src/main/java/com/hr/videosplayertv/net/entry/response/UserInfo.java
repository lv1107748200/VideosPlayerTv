...
public class UserInfo {
    ...
    public com.hr.videosplayertv.net.entry.response.UserToken getUserToken() {
        return UserToken;
    }

    public void setUserToken(com.hr.videosplayertv.net.entry.response.UserToken userToken) {
        UserToken = userToken;
    }
