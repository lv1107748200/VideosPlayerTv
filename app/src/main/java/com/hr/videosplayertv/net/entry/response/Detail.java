...
public class Detail {
    ...
    public com.hr.videosplayertv.net.entry.response.VideoServer getVideoServer() {
        return VideoServer;
    }

    public void setVideoServer(com.hr.videosplayertv.net.entry.response.VideoServer videoServer) {
    ...
    public com.hr.videosplayertv.net.entry.response.VL getVL() {
        return VL;
    }

    public void setVL(com.hr.videosplayertv.net.entry.response.VL VL) {
        this.VL = VL;
    }
