package com.hr.videosplayertv.widget.focus;
...
//            RectF mT = new RectF();
//            mT.set(mTempRectF.left - mBorderWidth,mTempRectF.top - mBorderWidth,mTempRectF.right + mBorderWidth,mTempRectF.bottom + mBorderWidth);
//            canvas.drawRoundRect(mT,mRoundRadius, mRoundRadius, mBorderPaint);
            canvas.restore();
        }
    }
