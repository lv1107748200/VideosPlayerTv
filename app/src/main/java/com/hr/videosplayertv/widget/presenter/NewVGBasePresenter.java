 ...
 * lv   2018/8/13  垂直的网格
 */
public class NewVGBasePresenter extends  RowPresenter {

    private static final String TAG = "NewVGBasePresenter";
    ...
    public static class ViewHolder extends RowPresenter.ViewHolder {
        final NewVGBasePresenter mListRowPresenter;
        final VerticalGridView mGridView;
        ItemBridgeAdapter mItemBridgeAdapter;
        final VlHoverCardSwitcher mHoverCardViewSwitcher = new VlHoverCardSwitcher();
        final int mPaddingTop;
        final int mPaddingBottom;
        final int mPaddingLeft;
        final int mPaddingRight;

        public ViewHolder(View rootView, VerticalGridView gridView, NewVGBasePresenter p) {
            super(rootView);
            mGridView = gridView;
            mListRowPresenter = p;
         ...
         */
        public final NewVGBasePresenter getListRowPresenter() {
    ...
    public static class SelectItemViewHolderTask extends Presenter.ViewHolderTask {
        ...
        public void run(Presenter.ViewHolder holder) {
            if (holder instanceof ListRowPresenter.ViewHolder) {
                VerticalGridView gridView = ((NewVGBasePresenter.ViewHolder) holder).getGridView();
    ...
    class ListRowPresenterItemBridgeAdapter extends ItemBridgeAdapter {
       NewVGBasePresenter.ViewHolder mRowViewHolder;

        ListRowPresenterItemBridgeAdapter(NewVGBasePresenter.ViewHolder rowViewHolder) {
            ...
            if (mRowViewHolder.getOnItemViewClickedListener() != null) {
                viewHolder.getViewHolder().view.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (mRowViewHolder.getOnItemViewClickedListener() != null) {
                            mRowViewHolder.getOnItemViewClickedListener().onItemClicked(viewHolder.getViewHolder(),
                                    ibh.getItem(), mRowViewHolder, (ListRow) mRowViewHolder.getRow());
                        }
                    }
                });
            }
     ...
     */
    public NewVGBasePresenter(int focusZoomFactor) {
     ...
     */
    public NewVGBasePresenter(int focusZoomFactor, boolean useFocusDimmer) {
    ...
    protected void initializeRowViewHolder(RowPresenter.ViewHolder holder) {
        ...
        rowViewHolder.mGridView.setNumColumns(mNumComs);
    }
    ...
    protected RowPresenter.ViewHolder createRowViewHolder(ViewGroup parent) {
        ...
        VGRowView rowView = new VGRowView(parent.getContext());
        setupFadingEffect(rowView);
        if (mRowHeight != 0) {
            rowView.getGridView().setColumnWidth(mRowHeight);
        }
    ...
    private void setupFadingEffect(VGRowView rowView) {
    ...
    protected void onRowViewExpanded(RowPresenter.ViewHolder holder, boolean expanded) {
        ...
        if (getRowHeight() != getExpandedRowHeight()) {
            ...
            vh.getGridView().setColumnWidth(newHeight);
        }
        setVerticalPadding(vh);
        updateFooterViewSwitcher(vh);
    }
    ...
    protected ColorOverlayDimmer mColorDimmer;
    ...
    protected void applySelectLevelToChild(ViewHolder rowViewHolder, View childView) {
        if (mShadowOverlayHelper != null && mShadowOverlayHelper.needsOverlay()) {
            ...
            mColorDimmer = ColorOverlayDimmer.createDefault(childView.getContext());

            int dimmedColor = mColorDimmer.getPaint().getColor();
