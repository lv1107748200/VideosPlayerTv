package com.hr.videosplayertv.widget.keyboard;
...
public class SkbContainer extends RelativeLayout implements SoftKeyBoardable {
	...
	private boolean setKeyCodeEnter(SoftKey softKey) {
		if (softKey == null) {
			NLog.e(KEY,"setKeyCodeEnter softKey is null");
			return false;
		}
	...
	public boolean onSoftKeyDown(int keyCode, KeyEvent event) {
		...
		NLog.e(KEY,"onSoftKeyDown keyCode:" + keyCode);
		switch (keyCode) {
		...
		case KeyEvent.KEYCODE_DPAD_CENTER:
			...
			NLog.e(KEY,"onSoftKeyDown softKey:" + softKey);
		...
		default:
			NLog.e(KEY,"onSoftKeyDown false keyCode:" + keyCode);

			return false;
		}
		NLog.e(KEY,"onSoftKeyDown true keyCode:" + keyCode);
		return true;
	}
	...
	public boolean onSoftKeyUp(int keyCode, KeyEvent event) {
		...
		NLog.e(KEY,"onSoftKeyUp keyCode:" + keyCode);
		if (mSoftKeyboardView != null)
			mSoftKeyboardView.setSoftKeyPress(false);
		switch (keyCode) {
		case KeyEvent.KEYCODE_ENTER:
		...
		case KeyEvent.KEYCODE_DPAD_DOWN: // 下
		case KeyEvent.KEYCODE_BACK:
			NLog.e(KEY,"onSoftKeyUp true keyCode:" + keyCode);
			return true;
		}
		NLog.e(KEY,"onSoftKeyUp false keyCode:" + keyCode);
		return false;
	}
