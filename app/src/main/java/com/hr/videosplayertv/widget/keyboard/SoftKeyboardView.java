...
public class SoftKeyboardView extends View {
	...
	protected void onDraw(Canvas rootCanvas) {
		...
		if (mCacheBitmap == null) {
			NLog.e(KEY,"onDraw mCacheBitmap:" + mCacheBitmap);
	...
	public void setSoftKeyPress(boolean isPress) {
		if (mSoftKeyboard == null) {
			NLog.e(KEY,"setSoftKeyPress isPress:");
			return;
		}
	...
	public boolean moveToNextKey(int direction) {
		if (mSoftKeyboard == null) {
			NLog.e(KEY,"moveToNextKey mSoftKeyboard is null");
			return false;
		}
		...
		if (keyRow == null) {
			NLog.e(KEY,"moveToNextKey keyRow is null");
			return false;
		}

		List<SoftKey> softKeys = keyRow.getSoftKeys();
		if (softKeys == null) {
			NLog.e(KEY,"moveToNextKey keyRow -> softKeys is null");
			return false;
		}
